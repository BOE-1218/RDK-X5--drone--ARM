...
本项目是一套面向高压输电线路的无人机自主除冰清障系统，以 **RDK X5 边缘计算平台** 为大脑 🧠，将四旋翼无人机与六轴轻量化机械臂集成到同一空中平台。

**RDK X5** 是整个系统的核心计算枢纽，承担感知推理、实时建图、路径规划与多机协同的全栈计算任务。其 8 TOPS 算力为 YOLOv8 目标检测、DehazeFormer 去雾网络、OctoMap 三维建图及 EgoPlanner 轨迹优化提供硬件加速，使无人机在复杂输电环境中实现毫秒级响应。
